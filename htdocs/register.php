...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $phone_regex = '/^[0-9]{7,15}$/'; // 7-15 cyfr po kodzie kraju
    
    // Walidacja numeru prawa jazdy - podstawowa walidacja dla międzynarodowych formatów
    ...
    if ($password !== $confirm_password) {
        ...
        // SPRAWDZENIE 1: Czy email lub username już istnieje
        ...
        // SPRAWDZENIE 2: Czy numer prawa jazdy już istnieje
        ...
        if ($check_user_stmt->rowCount() > 0) {
            ...
            try {
                ...
                // Dodaj użytkownika (z krajem i językiem)
...
<div class="auth-container">
    ...
    <form method="POST" class="auth-form">
        ...
        <!-- Nowe pola: kraj pochodzenia i język -->
        <div class="form-group">
